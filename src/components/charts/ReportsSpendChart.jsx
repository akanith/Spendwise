...
const ReportsSpendChart = ({ data = [], activeIndex = -1 }) => {
  if (!data || data.length === 0) {
    return (
      <div className="h-[280px] w-full flex items-center justify-center text-spendwise-text-muted text-xs font-bold uppercase tracking-widest bg-slate-50/50 rounded-3xl border border-dashed border-slate-200">
